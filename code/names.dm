...
var/list/lizard_male = file2list("config/names/lizard_male.txt")
var/list/lizard_female = file2list("config/names/lizard_female.txt")
var/list/golem_name = file2list("config/names/golem.txt")
var/list/plasmaman_name = file2list("config/names/plasmaman.txt")
var/list/ogre_names = file2list("config/names/ogre.txt")
