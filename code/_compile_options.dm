...
//MINOR TWEAKS/MISC
#define AGE_MIN				14	//youngest a character can be
#define AGE_MAX				60	//oldest a character can be
#define SHOES_SLOWDOWN		0	//How much shoes slow you down by default. Negative values speed you up
#define STRIP_DELAY			30	//time taken (in deciseconds) to strip somebody
...
#define MAX_STACK_AMOUNT_RODS	50

#define AI_CAMERA_LUMINOSITY	5

#define TRANSITIONEDGE			1 //Distance from edge to move to another z-level

#define shuttle_time_in_station	3000 // 1800 = 3 minutes in the station
#define shuttle_time_to_arrive	1800 // 6000 = 10 minutes to arrive
...
#define LOW_PRESSURE_DAMAGE					0.5		//The amounb of damage someone takes when in a low pressure area (The pressure threshold is so low that it doesn't make sense to do any calculations, so it just applies this flat value).
