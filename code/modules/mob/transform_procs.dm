...
//	sleep(48)
	...
	//O.name = "monkey"
	O.name = text("monkey ([rand(1, 1000)])")
	O.dna = dna
	dna = null
...
//Bad mobs! - Remember to add a comment explaining what's wrong with the mob
	...
	if(ispath(MP, /mob/living/simple_animal/hostile/construct/behemoth))
	...
	if(ispath(MP, /mob/living/simple_animal/hostile/construct/armoured))
	...
	if(ispath(MP, /mob/living/simple_animal/hostile/construct/wraith))
		return 0 //Verbs do not appear for players. These constructs should really have their own class simple_animal/construct/subtype

	if(ispath(MP, /mob/living/simple_animal/hostile/construct/builder))
		return 0 //Verbs do not appear for players. These constructs should really have their own class simple_animal/construct/subtype
