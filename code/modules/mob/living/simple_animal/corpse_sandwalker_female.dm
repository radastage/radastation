/obj/effect/landmark/sandwalkercorpsefemale
	name = "Unknown"
...
/obj/effect/landmark/sandwalkercorpsefemale/New()
	createCorpse()

/obj/effect/landmark/sandwalkercorpsefemale/proc/createCorpse() //Creates a mob and checks for gear in each slot before attempting to equip it.
	var/mob/living/carbon/human/M = new /mob/living/carbon/human (src.loc)
//	M.real_name = src.name
	M.stat = 2 //Kills the new mob
	dna = new /datum/dna(M)
	M.dna.mutantrace = "lizard"
	M.icon += rgb(200, 15, 200)
	M.gender = FEMALE
	M.underwear = null
	...
	M.real_name = capitalize(pick(lizard_female)) + "-" + capitalize(pick(lizard_female))
	del(src)

/obj/effect/landmark/sandwalkercorpsefemale/sandwalker
	name = "Sandwalker"
