/obj/effect/landmark/sandwalkercorpse
	name = "Unknown"
...
/obj/effect/landmark/sandwalkercorpse/New()
	createCorpse()

/obj/effect/landmark/sandwalkercorpse/proc/createCorpse() //Creates a mob and checks for gear in each slot before attempting to equip it.
...
//	M.real_name = src.name
	...
	M.gender = MALE
	M.real_name = random_name_lizard(gender)
	M.underwear = null
...
/obj/effect/landmark/sandwalkercorpse/sandwalker
	name = "Sandwalker"
