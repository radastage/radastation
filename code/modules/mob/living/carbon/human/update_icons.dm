...
/mob/living/carbon/human/update_inv_w_uniform()
	...
	if(istype(w_uniform, /obj/item/clothing/under))
		...
		var/icon/uni_s = icon("icon"='icons/mob/uniform.dmi', "icon_state"="[t_color]_s")
		var/icon/uni_l = icon("icon"='icons/mob/uniform.dmi', "icon_state"="[t_color]_l")
		if(U.rgb)
			uni_s.ColorTone("[U.rgb]")
			uni_l.ColorTone("[U.rgb]")
		var/image/lying		= image("icon"=uni_l, "icon_state"="[t_color]_l", "layer"=-UNIFORM_LAYER)
		var/image/standing	= image("icon"=uni_s, "icon_state"="[t_color]_s", "layer"=-UNIFORM_LAYER)
...
/mob/living/carbon/human/update_inv_glasses()
	...
	if(glasses)
		...
		var/icon/glasses_l = icon("icon"='icons/mob/eyes.dmi', "icon_state"="[glasses.icon_state]2")
		var/icon/glasses_s = icon("icon"='icons/mob/eyes.dmi', "icon_state"="[glasses.icon_state]")
		if(GL.rgb)
			glasses_l.ColorTone("[GL.rgb]")
			glasses_s.ColorTone("[GL.rgb]")
		var/image/lying		= image("icon"=glasses_l, "icon_state"="[glasses.icon_state]2", "layer"=-GLASSES_LAYER)
		var/image/standing	= image("icon"=glasses_s, "icon_state"="[glasses.icon_state]", "layer"=-GLASSES_LAYER)
		overlays_lying[GLASSES_LAYER]		= lying
...
/mob/living/carbon/human/update_inv_shoes()
	...
	if(shoes)
		...
		var/icon/shoes_l = icon("icon"='icons/mob/feet.dmi', "icon_state"="[shoes.icon_state]2")
		var/icon/shoes_s = icon("icon"='icons/mob/feet.dmi', "icon_state"="[shoes.icon_state]")

		var/obj/item/clothing/shoes/SH = shoes
		if(SH.rgb)
			shoes_l.ColorTone("[SH.rgb]")
			shoes_s.ColorTone("[SH.rgb]")

		var/image/lying		= image("icon"=shoes_l, "icon_state"="[shoes.icon_state]2", "layer"=-SHOES_LAYER)
		var/image/standing	= image("icon"=shoes_s, "icon_state"="[shoes.icon_state]", "layer"=-SHOES_LAYER)
...
/mob/living/carbon/human/update_inv_head()
	...
	if(head)
		...
		var/icon/head_l = icon("icon"='icons/mob/head.dmi', "icon_state"="[head.icon_state]2")
		var/icon/head_s = icon("icon"='icons/mob/head.dmi', "icon_state"="[head.icon_state]")

		var/obj/item/clothing/head/HD = head
		if(HD.rgb)
			head_l.ColorTone("[HD.rgb]")
			head_s.ColorTone("[HD.rgb]")
		...
		if(istype(head,/obj/item/clothing/head/kitty))
			...
			lying		= image("icon"=head_l, "icon_state"="[head.icon_state]2", "layer"=-HEAD_LAYER)
			standing	= image("icon"=head_s, "icon_state"="[head.icon_state]", "layer"=-HEAD_LAYER)
...
/mob/living/carbon/human/update_inv_wear_suit()
	...
	if(istype(wear_suit, /obj/item/clothing/suit))
		...
		var/icon/suit_l = icon("icon"='icons/mob/suit.dmi', "icon_state"="[wear_suit.icon_state]2")
		var/icon/suit_s = icon("icon"='icons/mob/suit.dmi', "icon_state"="[wear_suit.icon_state]")
		if(T.rgb)
			suit_l.ColorTone("[T.rgb]")
			suit_s.ColorTone("[T.rgb]")
		var/image/lying		= image("icon"=suit_l, "icon_state"="[wear_suit.icon_state]2", "layer"=-SUIT_LAYER)
		var/image/standing	= image("icon"=suit_s, "icon_state"="[wear_suit.icon_state]", "layer"=-SUIT_LAYER)
...
/mob/living/carbon/human/update_inv_wear_mask()
	...
	if(istype(wear_mask, /obj/item/clothing/mask))
		...
		var/obj/item/clothing/mask/MA = wear_mask
		var/icon/mask_l = icon("icon"='icons/mob/mask.dmi', "icon_state"="[wear_mask.icon_state]2")
		var/icon/mask_s = icon("icon"='icons/mob/mask.dmi', "icon_state"="[wear_mask.icon_state]")
		if(MA.rgb)
			mask_l.ColorTone("[MA.rgb]")
			mask_s.ColorTone("[MA.rgb]")
		var/image/lying		= image("icon"=mask_l, "icon_state"="[wear_mask.icon_state]2", "layer"=-FACEMASK_LAYER)
		var/image/standing	= image("icon"=mask_s, "icon_state"="[wear_mask.icon_state]", "layer"=-FACEMASK_LAYER)
