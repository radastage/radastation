...
/mob/living/carbon/human/verb/edit_appearance()
	set category = "IC"
	set name = "Edit Appearance"
	set desc = "Grooming."

	if(src.gender == MALE)
		var/new_style = input(src, "Select a facial hair style", "Grooming")  as null|anything in facial_hair_styles_list
		if(new_style)
	...
	//handle normal hair
	var/new_style = input(src, "Select a hair style", "Grooming")  as null|anything in hair_styles_list
	if(new_style)
...
/mob/living/carbon/human/verb/rename()
	...
	src.rename_self("currently named [src.real_name]", 1)

/*
/mob/living/carbon/human/verb/change_undervear()
	set category = "IC"
	set name = "Change Underwear"
	set desc = "Change your character's underwear."
	var/new_undies = input(src, "Select your underwear", "Changing")  as null|anything in underwear_all

	if(new_undies)
		src.underwear = new_undies
