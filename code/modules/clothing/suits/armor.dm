...
/obj/item/clothing/suit/armor/heavy
	...
	slowdown = 3
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT
	armor = list(melee = 75, bullet = 55, laser = 50, energy = 50, bomb = 55, bio = 0, rad = 0)
...
/obj/item/clothing/suit/armor/riot/fake
	name = "fake riot suit"
	cold_protection = CHEST
	heat_protection = CHEST
	slowdown = 0
...
/obj/item/clothing/suit/armor/vest/hivebot
	name = "hivebot armor"
	desc = "Part of a hivebot. Protects against some damage."
	icon_state = "hivebot"
	item_state = "hivebot"
