		...
		switch(menustat)
			if("menu")
				if (beaker)
					...
					dat += "<A href='?src=\ref[src];action=create;item=laceup;cost=200'>Laceup Shoes</A> <FONT COLOR = blue>(200)</FONT><BR>"
					dat += "<A href='?src=\ref[src];action=create;item=jackboots;cost=400'>Jackboots</A> <FONT COLOR = blue>(400)</FONT><BR>"
					dat += "<A href='?src=\ref[src];action=create;item=coat;cost=600'>Armored Coat</A> <FONT COLOR = blue>(600)</FONT><BR>"
					dat += "<A href='?src=\ref[src];action=create;item=trenchoat;cost=600'>Armored Trenchoat</A> <FONT COLOR = blue>(600)</FONT><BR>"
					dat += "<A href='?src=\ref[src];action=create;item=hoshat;cost=500'>Head of Security Hat</A> <FONT COLOR = blue>(500)</FONT><BR>"
					dat += "<A href='?src=\ref[src];action=create;item=briefcase;cost=300'>Briefcase</A> <FONT COLOR=blue>(300)</FONT><BR>"
					dat += "<A href='?src=\ref[src];action=create;item=plantbag;cost=150'>Plant Bag</A> <FONT COLOR=blue>(150)</FONT><BR>"
...
/obj/machinery/biogenerator/proc/create_product(var/item,var/cost)
	...
	switch(item)
		...
		if("laceup")
			new/obj/item/clothing/shoes/laceup(src.loc)
		if("jackboots")
			new/obj/item/clothing/shoes/jackboots(src.loc)
		if("coat")
			new/obj/item/clothing/suit/armor/hos(src.loc)
		if("trenchoat")
		...
		if("plantbag")
			new/obj/item/weapon/storage/bag/plants(src.loc)
		if("orebag")
			new/obj/item/weapon/storage/bag/ore(src.loc)
		if("trashbag")
