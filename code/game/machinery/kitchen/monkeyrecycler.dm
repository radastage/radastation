...
/obj/machinery/monkey_recycler/attack_hand(var/mob/user as mob)
	...
	if(grinded >=2)
		...
		grinded -= 2
		new /obj/item/weapon/storage/box/monkeycubes(src.loc)
		user << "\blue The machine's display flashes that it has [grinded] monkeys worth of material left."
	else
		user << "\red The machine needs at least 2 monkeys worth of material to produce a monkey cube. It only has [grinded]."
	return
