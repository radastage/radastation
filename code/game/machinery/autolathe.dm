...
/obj/machinery/autolathe
 ...
 \
		...
		new /obj/item/weapon/cable_coil/random(), \
		...
		new /obj/item/weapon/airlock_painter(), \
		...
		new /obj/item/weapon/scythe(), \
		new /obj/item/weapon/mop(), \
		new /obj/item/weapon/handcuffs(), \
		new /obj/item/weapon/camera_assembly(), \
		new /obj/item/weapon/cell/high(), \
	)
	var/list/LL = list( \
		...
		new /obj/item/weapon/gun/projectile/detective(), \
		new /obj/item/weapon/gun/projectile/p08(), \
		new /obj/item/weapon/gun/projectile/automatic/c05r(), \
		new /obj/item/ammo_magazine/c9mm(), \
		new /obj/item/ammo_casing/shotgun/dart(), \
		new /obj/item/weapon/gun/energy/laser/retro(), \
