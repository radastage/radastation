...
/obj/effect/stationloot
	...
	var/list/spawnthing = list(	/obj/machinery/vending/robotics								= 6,
							...
							/obj/effect/mobspawn/ogre										= 1,
							/obj/effect/mobspawn/test_subject								= 1,
							/obj/effect/mobspawn/prisoner									= 1,
							/obj/effect/mobspawn/wizard										= 1,
							/obj/effect/mobspawn/nurse										= 1,
							/obj/effect/mobspawn/tourist									= 1,
							/obj/effect/mobspawn/mailman									= 1,
							/obj/effect/mobspawn/waiter										= 1,
							/obj/effect/mobspawn/revolutionary								= 1,
							/obj/effect/mobspawn/headrev									= 1,
							/obj/effect/mobspawn/space_explorer								= 1,
							/obj/effect/mobspawn/space_miner								= 1,
							/obj/effect/mobspawn/plasma_researcher							= 1,
							...
							/obj/effect/workplace_xenobiology								= 5,
							/obj/effect/workplace_robotics									= 5,
