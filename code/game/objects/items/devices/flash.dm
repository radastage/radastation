...
/obj/item/device/flash/synthetic/makeshift
	name = "makeshift flash"
	icon_state = "proxflash"
	desc = "Cheap makeshift flash."
	origin_tech = "magnets=1;combat=1"
	construction_cost = list("metal"=860, "glass"=300)
	m_amt = 860
	g_amt = 300

/obj/item/device/flash/synthetic/makeshift/attack(mob/living/M, mob/user)
	..()
	if(!broken)
		broken = 1
		user << "<span class='warning'>The bulb has burnt out!</span>"
		icon_state = "proxflashburnt"

/obj/item/device/flash/synthetic/makeshift/attack_self(mob/living/carbon/user, flag = 0, emp = 0)
	..()
	if(!broken)
		broken = 1
		user << "<span class='warning'>The bulb has burnt out!</span>"
