...
/obj/item/weapon/storage/box/fakeriotsuit
	name = "boxed riot suit"
	desc = "A sleek, sturdy box used to hold replica riot suits"
	icon_state = "idOld"

	New()
		..()
		new /obj/item/clothing/suit/armor/riot/fake( src )
		new /obj/item/clothing/head/helmet/riot/fake( src )

/obj/item/weapon/storage/box/fakearmor
	name = "boxed armor"
	desc = "A sleek, sturdy box used to hold fake armor suits"
	icon_state = "idOld"

	New()
		..()
		new /obj/item/clothing/suit/armor/vest/fake( src )
		new /obj/item/clothing/head/helmet/fake( src )

/obj/item/weapon/storage/box/components
	name = "stock parts"
	desc = "A sleek, sturdy box used to hold stock parts."
	icon_state = "disk_kit"
