...
/obj/item/weapon/bedsheet/verb/fold_suit()
	set name = "Turn Bedsheet Into A Suit"
	set category = "Object"
	set src in usr
	...
	if(type != /obj/item/weapon/bedsheet)
		usr << "\blue You can't fold [src]!"
		return 0

	new /obj/item/clothing/suit/bedsheet(usr.loc)
