...
datum/controller/lighting
	...
	var/process_cost = 0
	var/iteration = 0
	var/max_cpu_use = 10//98		//this is just to prevent it queueing up when the server is dying. Not a solution, just damage control while I rethink a lot of this and try out ideas.
